"""autogenerated by genpy from uts_recogniser/ObjectPose.msg. Do not edit."""
import sys
...
class ObjectPose(genpy.Message):
  _md5sum = "2ed0d3dd1a0ec7eac29af61880cd83c3"
  _type = "uts_recogniser/ObjectPose"
...
"""
  __slots__ = ['name','pose','convex_hull_x','convex_hull_y','mean_quality','used_points','properties','pose_uncertainty_list']
  _slot_types = ['string','geometry_msgs/Pose','int16[]','int16[]','float32','int16','uts_recogniser/NameTypeValue[]','geometry_msgs/Pose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,pose,convex_hull_x,convex_hull_y,mean_quality,used_points,properties,pose_uncertainty_list
