"""autogenerated by genpy from uts_recogniser/herbActionResult.msg. Do not edit."""
import sys
...
class herbActionResult(genpy.Message):
  _md5sum = "680a85266a8aa85a1a55ddf6c8624d43"
  _type = "uts_recogniser/herbActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','uts_recogniser/herbResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(herbActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = uts_recogniser.msg.herbResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = uts_recogniser.msg.herbResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.info = str[start:end].decode('utf-8')
      else:
