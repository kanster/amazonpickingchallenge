"""autogenerated by genpy from uts_recogniser/SignalActionResult.msg. Do not edit."""
import sys
...
class SignalActionResult(genpy.Message):
  ...
  _type = "uts_recogniser/SignalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','uts_recogniser/SignalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = uts_recogniser.msg.SignalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = uts_recogniser.msg.SignalResult()
