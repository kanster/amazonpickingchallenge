"""autogenerated by genpy from uts_recogniser/PixelCoordinateList.msg. Do not edit."""
import sys
...
class PixelCoordinateList(genpy.Message):
  ...
  _type = "uts_recogniser/PixelCoordinateList"
...
================================================================================
MSG: uts_recogniser/PixelCoordinate
int16 x
int16 y

"""
  __slots__ = ['header','coordinates','originalTimeStamp']
  _slot_types = ['std_msgs/Header','uts_recogniser/PixelCoordinate[]','time']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uts_recogniser.msg.PixelCoordinate()
        _x = val1
        start = end
        end += 4
